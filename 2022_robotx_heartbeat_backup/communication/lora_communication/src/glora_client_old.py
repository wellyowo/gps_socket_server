...
class Sender(object):
    def __init__(self):
        ...
        elif self.veh.lower() == 'duckiefloat3':
            self.identity_byte = 0x40
        elif self.veh.lower() == 'duckiefloat4':
            self.identity_byte = 0x50
    ...
    def process(self, event):
        ...
        cmd_data = struct.unpack('12B', tmp_pack)
    ...
    def subt_msg_cb(self, msg):
        ...
        if rospy.Time.now()-self.timer_start >= rospy.Duration(ROBOT_POSE_SAMPLE_PERIOD):
